<?php // Etiquetas de php
    ...
    */
    ...
    # Número
    $edad = 24;
    # Boleano en caso de ser FALSE se define como 0, pero puede ser TRUE verdadero 1
    $verdad_bool = TRUE;
    ...
    echo $nombre;
    echo "<br />La suma número y carácter númerico funciona = ";
	$numero_a = 2;
	$caracter_b = "3";
    ...
    echo "<br />";
    $a = 23.76545678;
    # Redondeo especificando número de decimales
    echo round($a, 3);
    echo "<br />";
